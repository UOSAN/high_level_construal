...
function scenario_trialsLoopBegin(scenario_trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  scenario_trials.forEach(function() {
...
function action_trialsLoopBegin(action_trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  action_trials.forEach(function() {
...
function block_setupRoutineBegin(snapshot) {
  return function () {
    ...
    block_setupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scenario_cueRoutineBegin(snapshot) {
  return function () {
    ...
    scenario_cueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scenario1RoutineBegin(snapshot) {
  return function () {
    ...
    scenario1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scenario2RoutineBegin(snapshot) {
  return function () {
    ...
    scenario2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scenario3RoutineBegin(snapshot) {
  return function () {
    ...
    scenario3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function quitting_intentionRoutineBegin(snapshot) {
  return function () {
    ...
    quitting_intentionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
